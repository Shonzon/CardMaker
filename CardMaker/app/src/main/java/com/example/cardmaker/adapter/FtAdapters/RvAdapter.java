...
public class RvAdapter extends RecyclerView.Adapter<RvAdapter.MyHolder>{
    ...
    public RvAdapter(Context context,List<RvModel> listdata) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.test_card,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        holder.pphone.setText(listdata.get(position).getPhone());
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        final TextView pname,email,pdec1,pdec2,pdec3,pphone,designation,optionMenu;
        final ImageView logo_image;
        ...
        public MyHolder(final View itemView) {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.add:
                                    ...
                                    DatabaseReference imgRef=mDatabase.getReference("testtemp")
                                            .child("one").child("001").child("logo");
                                    ...
                                    String imagePath= imageUri;


                                    RvModel data = new RvModel(pname.getText().toString()
                                            ...
                                            ,imagePath);
                                    myRef.child("one").setValue(data);
                                    Toast.makeText(v.getContext(),"Added to mycard",Toast.LENGTH_SHORT);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    //Uri path = Uri.parse("android.resource://com.example.look.snp/" + R.drawable.constant);
                    ...
                    Intent edit1 = new Intent(mContext, McEdit.class);
                    edit1.putExtra("logo",imgPath);

                    firebaseDatabase = FirebaseDatabase.getInstance();
                    myRef = firebaseDatabase.getReference("usertemplate").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("one");

                    HashMap<String, Object> result1 = new HashMap<>();
                    result1.put("name", "Sahara Kumkum");
