...
public class RvModel3 {
    private String name,designation,email,dec1,dec2,dec3,logo;
    private long phone;

    public RvModel3() {
    }

    public RvModel3(String name, String designation, long phone, String email, String
