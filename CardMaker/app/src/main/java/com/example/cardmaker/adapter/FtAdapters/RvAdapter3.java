...
import com.example.cardmaker.MyCardEdit.McEdit3;
...
public class RvAdapter3 extends RecyclerView.Adapter<RvAdapter3.MyHolder>{

    List<RvModel3> listdata;
    Context mContext;

    public RvAdapter3(Context context, List<RvModel3> listdata) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.test_card3,viewGroup,false);
    ...
    class MyHolder extends RecyclerView.ViewHolder{
        ...
        TextView name,email,pdec1,pdec2,pdec3,pphone,designation,optionMenu;
        ...
        public MyHolder(final View itemView) {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            switch (item.getItemId()) {
                                case R.id.add:
                                    ...
                                    RvModel3 data = new RvModel3(name.getText().toString()
                                            ...
                                            ,imageUri);
                                    myRef.child("four").setValue(data);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent edit1 = new Intent(mContext, McEdit3.class);
                    edit1.putExtra("logo",imgPath);

                    FirebaseDatabase firebaseDatabase;
                    DatabaseReference myRef;
                    firebaseDatabase = FirebaseDatabase.getInstance();
                    myRef = firebaseDatabase.getReference("usertemplate").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("four");
